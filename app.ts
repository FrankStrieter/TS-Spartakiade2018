...
const noteWithTodo: NoteWithTodos = new NoteWithTodos(1, "Typescript ist Toll", "das ist wirklich so", [
	{
		title: "Doku lesen",
		checked: true,
	},
...
noteWithTodo.addTodo({item: {title: "dependencies installieren", checked: false},position: "first"});
